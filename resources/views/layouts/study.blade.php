...
@section('title', 'GTWTravels - Study Abroad')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center">
                        <h1 class="text-30 fw-600">Study</h1>
        ...
        <div class="container">
            <div class="row justify-center">
                <div class="col-lg-12">
                    ...
                    >
                        <form method="POST" action="{{route('study.submit.request')}}">
                            @csrf
                            <div class="row y-gap-20">
                                ...
                                <div class="col-6">
                                    <div class="form-input">
                                        ...
                                        <label class="lh-1 text-14 text-light-1">Course</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-input">
                                        ...
                                        <label class="lh-1 text-14 text-light-1">Year</label>
                                    </div>
                                </div>

                                <div class="col-12">
                                    <div class="form-input">
                                        <select id="country" name="country" class="form-control" style="height:60px;"
                                                required>
                                            <option>Please select Country for your studies</option>
