        ...
        <div class="row justify-between items-center">
            ...
            <div class="d-flex items-center ml-20 is-menu-opened-hide md:d-none">
                <a href="{{@route('consultation')}}"
                   class="button px-30 fw-400 text-14 -dark-1 bg-blue-1 h-50 text-white">Book a Consultation</a>
            </div>
            <div class="col-auto">
                <div class="d-flex items-center">
                    ...
                    <div class="d-none xl:d-flex x-gap-20 items-center pl-30 text-white" data-x="header-mobile-icons"
                        ...
                        <a href="{{@route('consultation')}}"
                           class="button px-30 fw-400 text-14 -dark-1 bg-blue-1 h-50 text-white">Book a
                            Consultation</a>
                        <div>
                            <button class="d-flex items-center icon-menu text-dark text-20"
