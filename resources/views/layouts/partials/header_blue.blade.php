...
<header
    data-add-bg=""
    class="header bg-dark-3 js-header"
    data-x="header"
            ...
            <div class="col-auto">
                <div class="d-flex items-center">
                    <div class="row x-gap-20 items-center xxl:d-none">
                        <div class="col-auto">
                            <button
                                class="d-flex items-center text-14 text-dark-1"
                    ...
                    >
                        <a
                            href="{{@route('contact')}}"
                            class="button px-30 fw-400 text-14 -blue-1 bg-blue-1 h-50 text-white"
                        >Consultations</a
                        >
                    </div>
                    ...
                    >
                        <div>
                            <button
                                class="d-flex items-center icon-menu text-20"
