(function () {
    ...
    function initMapSingle() {
        ...
        const locations = [{lat: 6.446147, lng: 3.4676686}];
    ...
    const ShowMore = (function () {
        function init() {
            ...
            targets.forEach((el, i) => {
                ...
                const changingTextButton = el.querySelector(
                    "[data-show-more-change-text]"
                );
...
countries.forEach((country) => {
    ...
    optionDiv.className = "select__options__button";
    optionDiv.setAttribute(
        "data-value",
        country.toLowerCase().replace(/&/g, "_")
    ); // Replace '&' with '_' for valid HTML attribute
    optionDiv.textContent = country;
    selectOptionsContainer.appendChild(optionDiv);
});
